      ...
      <div class="page-content">
        ...
        <div class="employees-container">
                ...
                <td>
                  <div class="employee-info">
                    ...
                    <div class="employee-details">
                      ...
                      <div class="employee-position">DNI: 12345678</div>
                    </div>
                  </div>
                </td>
                <td>Analista Administrativo</td>
                <td>Administración</td>
                <td><span class="role role-employee">Empleado</span></td>
                ...
                <td>
                  <div class="employee-info">
                    ...
                    <div class="employee-details">
                      ...
                      <div class="employee-position">DNI: 87654321</div>
                    </div>
                  </div>
                </td>
                <td>Especialista RRHH</td>
                <td>Recursos Humanos</td>
                <td><span class="role role-supervisor">Supervisor</span></td>
                <td><span class="status status-active">Activo</span></td>
                <td>20/06/2019</td>
                <td class="actions">
                  <button class="action-btn edit" title="Editar">
                ...
                <td>
                  <div class="employee-info">
                    ...
                    <div class="employee-details">
                      ...
                      <div class="employee-position">DNI: 11223344</div>
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="employee-info">
                    ...
                    <div class="employee-details">
                      ...
                      <div class="employee-position">DNI: 44332211</div>
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="employee-info">
                    ...
                    <div class="employee-details">
                      ...
                      <div class="employee-position">DNI: 55667788</div>
                    </div>
                  </div>
                </td>
          ...
          <div class="pagination">
            <div class="pagination-info">Mostrando 1-5 de 55 empleados</div>
