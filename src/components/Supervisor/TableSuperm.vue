...
// Logic for Supervisor table actions
// Supervisors approve permissions (sign as jefe) or creating them
const isSigned = (permiso: Permiso) => {
  // For Supervisor view, we might want to hide Approve if they already signed (as Jefe Area)
  // Check if jefe signature exists
  return !!permiso.firma_jefe_area || !!permiso.firma_jefe_area_digital;
};
      ...
      <Column header="Acciones">
        <template #body="slotProps">
          <div class="flex gap-2">
            ...
            />
            <!-- Approve button for Supervisor (Sign as Boss) -->
            <Button
              icon="pi pi-check"
              text
              rounded
